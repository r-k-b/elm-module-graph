...
resultFromFile file =
    file.content
        |> Result.andThen (Json.Decode.decodeString ModuleGraph.decodeInput >> Result.mapError (always "Error"))
        |> Result.map ModuleGraph.init
...
viewSection =
    Html.div
        [ Html.Attributes.style "width" "360px"
